...
(function($) {
    var methods = {
        ...
        dataRender: function(_v, _data) {
            ...
            cells += '<caption>INFORMATION</caption>'+'<thead>' + '<tr>' + '<th>Id</th>'+ '<th>Name</th>' + '<th>startTime</th>' + ' <th>endTime</th>' + '</tr>' + '</thead><tbody>';
            for (var i = j * 8; i < temp; i++) {
                cells += '<tr><td>' + _data[i].id  + '</td>';
                cells += '<td>' + _data[i].title + '</td>';
                cells += '<td>' + _data[i].starttime + '</td>';
                cells += '<td>' + _data[i].endtime + '</td>';
                cells += '</tr>';
            }
            cells += '</tbody>';
